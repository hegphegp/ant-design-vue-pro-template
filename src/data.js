...
export const cascaderSelectData = [{
  value: 'zhejiang',
  label: 'Zhejiang',
  children: [{
    value: 'hangzhou',
...
export const selectData = [ { code: 'STATUS1', name: '状态1' }, { code: 'STATUS2', name: '状态2' }, { code: 'STATUS3', name: '状态3' }, { code: 'STATUS4', name: '状态4' }, { code: 'STATUS5', name: '状态5' } ]
